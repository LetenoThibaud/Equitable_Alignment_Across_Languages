...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', type=str, choices=['moral', 'jigsaw'], default='jigsaw', help='Dataset name')
    ...
    parser.add_argument('--lr_scheduler_type', type=str, default='constant', help='Lr scheduler type')
    ...
    target_dataset_fr = load_data('data/jigsaw/preference_toxicity_fr_test', args)
    target_dataset_en = load_data('data/jigsaw/preference_toxicity_en_test', args)

    save_path = 'jigsaw_experiment_' + args.ref_model
